---
title: how2heap-10 House of Force实践笔记
time: 2017-08-13
tags: [CTF, pwn, heap]
layout: post
categories: posts
...
本节示例的漏洞程序可以从此处下载： [house_of_force](/files/how2heap/house_of_force)
...
Let's allocate the first chunk, taking space from the wilderness.
The chunk of 256 bytes has been allocated at 0x603010.
...
The top chunk starts at 0x603118
...
The value we want to write to at 0x602080, and the top chunk is at 0x603118, so accounting for the header size,
we will malloc 0xffffffffffffef58 bytes.
As expected, the new pointer is at the same place as the old top chunk: 0x603120
